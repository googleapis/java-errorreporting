...
public interface ErrorContextOrBuilder
   ...
   */
  java.util.List<com.google.appengine.logging.v1.SourceReference> getSourceReferencesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.appengine.logging.v1.SourceReference source_references = 4;</code>
   */
  com.google.appengine.logging.v1.SourceReferenceOrBuilder getSourceReferencesOrBuilder(int index);
}

  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "urce.proto\032\037google/protobuf/timestamp.proto\032\034google/api/annotations.proto\"\262\002\n\n"
          + "ErrorGroup\022\014\n"
          + "\004name\030\001 \001(\t\022\020\n"
          + "\010group_id\030\002 \001(\t\022S\n"
          + "\017tracking_issues\030\003 \003(\0132:.google.devto"
          + "ols.clouderrorreporting.v1beta1.TrackingIssue\022X\n"
          + "\021resolution_status\030\005 \001(\0162=.googl"
          + "e.devtools.clouderrorreporting.v1beta1.ResolutionStatus:U\352AR\n"
          + "-clouderrorreportin"
          + "g.googleapis.com/ErrorGroup\022!projects/{project}/groups/{group}\"\034\n\r"
          + "TrackingIssue\022\013\n"
          + "\003url\030\001 \001(\t\"\357\001\n\n"
          + "ErrorEvent\022.\n\n"
          + "event_time\030\001 \001(\0132\032.google.protobuf.Timestamp\022T\n"
          + "\017service_context\030\002 \001(\0132;.google.devtools.c"
          + "louderrorreporting.v1beta1.ServiceContext\022\017\n"
          + "\007message\030\003 \001(\t\022J\n"
          + "\007context\030\005 \001(\01329.go"
          + "ogle.devtools.clouderrorreporting.v1beta1.ErrorContext\"I\n"
          ...
          + " \001(\0132?.google.devtools.clouderrorreporting.v1beta1.HttpRequestContext\022\014\n"
          + "\004user\030\002 \001(\t\022T\n"
          + "\017report_location\030\003 \001(\0132;.googl"
          + "e.devtools.clouderrorreporting.v1beta1.SourceLocation\"\210\001\n"
          ...
          + "/com.google.devtools.clouderrorreporting.v1beta1B\013Commo"
          + "nProtoP\001Z^google.golang.org/genproto/googleapis/devtools/clouderrorreporting/v1b"
          + "eta1;clouderrorreporting\370\001\001\252\002#Google.Clo"
          + "ud.ErrorReporting.V1Beta1\312\002#Google\\Cloud"
          + "\\ErrorReporting\\V1beta1\352\002&Google::Cloud::ErrorReporting::V1beta1b\006proto3"
    };
    descriptor =
